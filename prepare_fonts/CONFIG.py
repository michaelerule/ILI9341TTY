...
sketchdir = '../self_contained_Uno9341TFT_TTY_horizontal_v15/'
...
# C source for any subroutines required by the glyph transformation code
# These will be merged into the auto-generated unicode mapping C source code
transform_subroutines_filename = './fontdescription/glyph_transformation_subroutines.c'
...
transform_subroutines_filename = os.path.abspath(here + transform_subroutines_filename)
...
# (basiclatin is processed directly as ASCII). Any blocks you wish to support 
# that are not included here should be provided as custom subroutines.
mapped_blocks = [
'latin1supplement',
'latinextendeda',
'latinextendedb',
...
# your own hand-crafted subroutines. This should not include basiclating
# and shour not overlap the "mapped blocks" defined above
softmapped = [
'blockelements',
'boxdrawing',
'braillepatterns',
